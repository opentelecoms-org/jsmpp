...
public interface ResponseHandler {
     ...
     * 
     * @param commandStatus
     *            is the command status.
     * @param sequenceNumber
     *            is the sequence number original PDU if can be decoded.
     * @throws IOException
     ...
     *            is the original command id.
     * @param commandStatus
     *            is the command status.
     * @param sequenceNumber
     *            is the sequence number of original PDU request.
     * @throws IOException
     *             if an IO error occur.
     */
     ...
     * 
     * @param sequenceNumber
     *            is the sequence number of original <b>ENQUIRE_LINK</b>
     *            request.
     * @throws IOException
     *             if an IO error occur.
     */
     ...
     * 
     * @param sequenceNumber
     *            is the sequence number of original <b>UNBIND</b> request.
     * @throws IOException
     *             if an IO error occur.
     */
    public void sendUnbindResp(int sequenceNumber) throws IOException;

    void sendBindResp(String systemId, BindType bindType, int originalSequenceNumber) throws IOException;
