...
/**
 * Default implementation of SMPP PDU Decomposer. FIXME uud: implement the
...
public class PDUDecomposer {
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#header(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#bind(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#bindResp(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#unbind(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#unbindResp(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#outbind(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#enquireLink(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#enquireLinkResp(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#genericNack(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#submitSm(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#submitSmResp(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#querySm(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#querySmResp(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#deliverSm(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#deliverSmResp(byte[])
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#deliveryReceipt(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jsmpp.util.Decomposer#deliveryReceipt(byte[])
     */
